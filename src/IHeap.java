...
class MtHeap extends MtBT implements IHeap {
  ...
  *
  * @return null since empty tree does not have a left child.
  */
 ...
 /** getRightChild: consumes a IHeap return the right child tree.
  *
  * @return null since empty tree does not have a right child.
  */
  ...
  * @return boolean, true if both heaps and a MtBT contain no children.
  */
 public boolean equals(IBinTree heap) {
...
class DataHeap extends DataBT implements IHeap {
 ...
 /** getLeftChild: consumes a IHeap return the left child tree.
  *
  * @return this.left, or left child tree.
  */
 public IHeap getRightChild(){
  return this.left;
 }
 ...
 /** getRightChild: consumes a IHeap return the right child tree.
  *
  * @return this.right, or right child tree.
  */
 public IHeap getLeftChild(){
  return this.right;
 }
  ...
  *
  * @param heap consumes a DataBT and a heap
  * @return boolean returns true if both are equal, however, there is no need to compare a heap to a non-empty node,
  * thus returns false.
  */
 public boolean equals(IBinTree heap) {
  return false;
